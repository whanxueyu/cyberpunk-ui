...
const De = (e = []) => ({
  ...
  setup(e, { emit: s }) {
    const t = e, a = s, r = M(!1), i = M(null), l = M(null), c = M(null), h = M(t.position), p = M({}), $ = () => {
      if (!i.value || !l.value || t.position !== "auto")
        return t.position;
      const v = i.value.getBoundingClientRect(), k = l.value.getBoundingClientRect(), d = window.innerWidth, _ = window.innerHeight, y = v.top, S = d - v.right, T = _ - v.bottom, G = v.left, D = [
      ...
      c.value && clearTimeout(c.value), c.value = window.setTimeout(() => {
        r.value = !0, we(() => {
          t.position === "auto" ? h.value = $() : h.value = t.position, I(), a("show");
        });
      }, t.delay);
    }, m = () => {
      c.value && clearTimeout(c.value), c.value = window.setTimeout(() => {
      ...
      const v = i.value.getBoundingClientRect(), k = l.value.getBoundingClientRect(), d = window.pageYOffset || document.documentElement.scrollTop, _ = window.pageXOffset || document.documentElement.scrollLeft;
      let y = 0, S = 0;
      const T = 10;
      switch (h.value) {
        case "top":
          y = v.left + v.width / 2 - k.width / 2 + _, S = v.top - k.height - T + d;
          break;
        case "right":
          y = v.right + T + _, S = v.top + v.height / 2 - k.height / 2 + d;
          break;
        case "bottom":
          y = v.left + v.width / 2 - k.width / 2 + _, S = v.bottom + T + d;
          break;
        case "left":
          y = v.left - k.width - T + _, S = v.top + v.height / 2 - k.height / 2 + d;
          break;
      }
      (() => {
      ...
      r.value && (t.position === "auto" && (h.value = $()), I());
    }, g = () => {
    ...
    const E = (v) => {
      ...
      for (; d; ) {
        ...
        /(auto|scroll)/.test(_.overflow + _.overflowY + _.overflowX) && k.push(d), d = d.parentElement;
      }
...
}), Tt = /* @__PURE__ */ Y(It, [["__scopeId", "data-v-a87fdb91"]]), Vt = q(Tt), Et = ["src", "alt"], Lt = {
  key: 1,
    ...
    const s = e, t = M(null), a = M(null), r = N(() => s.direction === "vertical" ? "vertical" : "horizontal"), i = N(() => {
      ...
      const p = () => {
        ...
        if (Math.random() < s.glitchIntensity / 20) {
          const C = Math.random() * s.glitchIntensity - s.glitchIntensity / 2, w = Math.random() * s.glitchIntensity - s.glitchIntensity / 2, m = Math.random() * s.glitchIntensity - s.glitchIntensity / 2, I = Math.random() * s.glitchIntensity / 2;
          h.style.transform = `translate(${C}px, ${w}px) skew(${m}deg)`, h.style.filter = `blur(${I}px)`, h.style.opacity = "1", setTimeout(() => {
...
}), Ft = /* @__PURE__ */ Y(Kt, [["__scopeId", "data-v-1d2a0d29"]]), Yt = q(Ft), Gt = ["tabindex", "aria-disabled", "aria-label"], jt = { class: "holo-card-content" }, qt = {
  key: 0,
  class: "card-title"
}, Xt = /* @__PURE__ */ F({
  name: "CyberHoloCard",
  ...
  setup(e) {
    ...
    const s = Be(), t = me(), a = e, r = M({ x: 0, y: 0 }), i = M(!1), h = ((f, b) => {
      let x;
      return function() {
  ...
  setup(e) {
    const s = e, t = M(null), a = M(!1), r = M(!0), i = M(1), l = M(0), c = M(!1), h = M(0), p = Ne([]);
    s.data.length > 0 && p.splice(0, p.length, ...s.data);
    let $ = 0;
    const C = () => `row-${++$}-${Date.now()}`, w = N(() => s.rowNum * s.rowHeight), m = N(() => w.value), I = N(() => {
      ...
      return _.push(...d.slice(0, l.value)), _.slice(0, k);
      ...
      const v = p.length, k = s.rowNum;
      if (v <= k || (await new Promise((_) => setTimeout(_, s.waitTime)), c.value)) return;
      const d = async () => {
        if (c.value) return;
        const _ = h.value, y = s.scrollType === "page" ? k : 1;
        l.value = (l.value + y) % v;
        const S = s.scrollType === "page" ? 500 : 300;
        await new Promise((T) => setTimeout(T, S)), !(h.value !== _ || c.value) && (await new Promise((T) => setTimeout(T, s.waitTime)), !(h.value !== _ || c.value) && d());
      };
      d();
    }, O = () => {
...
}), _a = /* @__PURE__ */ Y(Ma, [["__scopeId", "data-v-d73343d5"]]), Ia = q(_a), Ta = ["data-word"], Va = /* @__PURE__ */ F({
  name: "CyberText",
  __name: "text",
  props: {
    lineColor: {
  ...
  setup(e, { emit: s }) {
    const t = e, a = s, r = M(), i = M(), l = M(!1), c = M(""), h = N(() => t.showCheck !== void 0 ? t.showCheck : t.multiple), p = N(() => {
      ...
      return $.value.filter((_) => d.some((y) => b(y, f(_))));
      ...
      const _ = f(d);
      return t.multiple ? (Array.isArray(t.modelValue) ? t.modelValue : []).some((S) => b(S, _)) : b(t.modelValue, _);
    }, B = (d) => {
      ...
      const _ = f(d);
      if (t.multiple) {
        const y = Array.isArray(t.modelValue) ? [...t.modelValue] : [], S = y.findIndex((G) => b(G, _));
        S > -1 ? y.splice(S, 1) : y.push(_);
        const T = $.value.filter((G) => y.some((D) => b(D, f(G))));
        a("update:modelValue", y), a("change", y, T);
        return;
      }
      a("update:modelValue", _), a("change", _, d), B(!1);
    }, g = (d) => {
      if (!t.multiple || t.disabled) return;
      const _ = f(d), S = (Array.isArray(t.modelValue) ? [...t.modelValue] : []).filter((G) => !b(G, _)), T = $.value.filter((G) => S.some((D) => b(D, f(G))));
      ...
      (n(!0), o(X, null, Z(h.value, (E) => (n(), o("div", {
        ...
        e.showConnectors && C(E) > 0 ? (n(), o("div", Wl, [
          ...
          u("span", {
            ...
            style: K({ left: `${(C(E) - 1) * e.indent + ye}px` })
          }, null, 6),
          u("span", {
            class: "horizontal-line",
            style: K({
              left: `${(C(E) - 1) * e.indent + ye}px`,
        ...
        ve(_e, { name: "cp-submenu" }, {
          default: ke(() => [
            l.value && h.value ? (n(), o("ul", {
              ...
              (n(!0), o(X, null, Z(e.item.children, (B) => (n(), xe(x, {
                key: B.value,
                item: B,
                depth: e.depth + 1,
...
}), Sn = /* @__PURE__ */ Y(Cn, [["__scopeId", "data-v-0a500770"]]), Mn = { class: "cp-cyber-menu-list" }, _n = {
  key: 0,
...
}), Tn = /* @__PURE__ */ Y(In, [["__scopeId", "data-v-69f0c141"]]), Vn = q(Tn), En = { class: "cp-scrollbar__corner" }, Ln = /* @__PURE__ */ F({
  name: "CyberScrollbar",
  __name: "scrollbar",
  props: {
    height: {
  ...
  setup(e, { expose: s }) {
    const t = e, a = M(null), r = M(null), i = M(null), l = M(null), c = M(null), h = M(null), p = M(0), $ = M(0), C = M(0), w = M(0), m = M(20), I = M(20), f = M(!1), b = M(!1);
    ...
    const O = { small: 5, default: 7, large: 10 }, E = N(() => {
      ...
      const L = a.value, j = r.value, ee = L.clientHeight, te = L.clientWidth, ae = j.scrollHeight, oe = j.scrollWidth, le = O[t.size] + 4, de = O[t.size] + 4, ce = ae > ee, pe = oe > te;
      ...
      te > 0 ? d(p.value + L.deltaY) : ae > 0 && _($.value + L.deltaY);
    }, T = (L) => {
      ...
      if (B === "v") {
        ...
        const te = L.clientX - H, ae = (c.value?.clientWidth || 0) - I.value, oe = ee.scrollWidth - j.clientWidth;
        if (ae > 0) {
          const le = oe / ae;
          _(Q + te * le);
        }
      ...
      const j = c.value, ee = a.value, te = r.value, ae = L.clientX - j.getBoundingClientRect().left - I.value / 2, oe = j.clientWidth - I.value, le = ae / oe;
      _(le * (te.scrollWidth - ee.clientWidth));
    };
    return ie(async () => {
      await we(), a.value && (a.value.addEventListener("scroll", y), r.value && (g = new ResizeObserver(() => k()), g.observe(r.value), g.observe(a.value)), k());
    }), ue(() => {
